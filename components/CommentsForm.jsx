...
const CommentsForm = ({ slug }) => {
    ...
    const [local_Storage, setLocal_Storage] = useState(null)
    ...
    return (
        <>
            <div className="bg-white shadow-lg rounded-lg p-8 pb-12 mb-8">
                ...
                {error && <p className='text-md text-red-500'>All fields are required</p>}
                <div className="mt-8">
                    <button
                        type='button'
                        onClick={handleCommentSubmission}
                        className="transition duration-500 ease hover:bg-indigo-900 inline-block bg-orange-400 text-lg rounded-full text-white px-8 py-3 cursor-pointer"
                    >Submit</button>
